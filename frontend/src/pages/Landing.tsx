  ...
  return (
    <div className="bg-base-100 text-base-content">
      ...
      <AnimatedSection className="container mx-auto px-4 py-20">
        <h3 className="text-4xl font-bold text-center mb-12">Recursos Incríveis</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <p>Cada projeto é um repositório Git, permitindo que você versione seu trabalho de forma eficiente.</p>
            </div>
          </div>
          {/* Feature 3 */}
          <div className="card bg-base-100 shadow-xl">
      ...
      <div className="bg-base-200">
        <AnimatedSection className="container mx-auto px-4 py-20">
          <h3 className="text-4xl font-bold text-center mb-12">O Que Nossos Usuários Dizem</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Testimonial 1 */}
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                <p>"O Superfolha revolucionou a forma como escrevo meus artigos. A compilação em tempo real é mágica!"</p>
                <h5 className="font-bold mt-4">- Dr. Ana Souza, Pesquisadora</h5>
              </div>
            </div>
            {/* Testimonial 2 */}
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                <p>"A melhor ferramenta para colaborar em documentos LaTeX que já usei. A integração com Git é perfeita."</p>
                <h5 className="font-bold mt-4">- João Silva, Estudante de Doutorado</h5>
              </div>
            </div>
            {/* Testimonial 3 */}
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                <p>"Finalmente uma solução moderna para LaTeX. A interface é limpa, intuitiva e muito poderosa."</p>
                <h5 className="font-bold mt-4">- Maria Oliveira, Desenvolvedora</h5>
              </div>
            </div>
          </div>
        </AnimatedSection>
